...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="citeseer", help="cora, citeseer, pubmed, photo")
    parser.add_argument("--models", nargs='+', default=['GCN'], help="'GCN', 'lp', 'cotraining', 'selftraining', 'union', 'intersection'")
    parser.add_argument("--label_rate", type=float, default=4, help="The rate of labeled samples(%) for recommend parameters.")
